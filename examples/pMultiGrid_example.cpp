...
class gsIncompleteLUT : public Eigen::IncompleteLUT<_Scalar, _StorageIndex>
{
public:
    const typename Eigen::IncompleteLUT<_Scalar, _StorageIndex>::FactorType factors() const
    { return this->m_lu; }

    const Eigen::PermutationMatrix<Eigen::Dynamic, Eigen::Dynamic, _StorageIndex> fillReducingPermutation() const
    { return this->m_P; }

    const Eigen::PermutationMatrix<Eigen::Dynamic, Eigen::Dynamic, _StorageIndex> inversePermutation() const
    { return this->m_Pinv; }
};
