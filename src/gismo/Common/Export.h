...
#  else /* compiler does not support symbol export */
...
#else // consuming shared library: import, don't export
...
#  else /* compiler does not support symbol import */
...
// GISMO_NO_EXPORT - For classes/functions that should definitely not be exported
#define GISMO_NO_EXPORT GISMO_LOCAL