...
namespace internal
{
    //CLASS_TEMPLATE_INST gsXml< gsMatrix<real_t> >; ok
    //CLASS_TEMPLATE_INST gsXml< gsMatrix<index_t> >; ok
    //CLASS_TEMPLATE_INST gsXml< gsSparseMatrix<real_t> >; ok
    // CLASS_TEMPLATE_INST gsXml< gsSparseMatrix<index_t> >; ok
    // CLASS_TEMPLATE_INST gsXml< gsSparseMatrix<bool> >; ok

    // CLASS_TEMPLATE_INST gsXml< gsGeometry<real_t> >; ok
    // CLASS_TEMPLATE_INST gsXml< gsCurve<real_t> >; ok
    // CLASS_TEMPLATE_INST gsXml< gsSurface<real_t> >; ok
    // CLASS_TEMPLATE_INST gsXml< gsBasis<real_t> >; ok
    ...
    //CLASS_TEMPLATE_INST gsXml< gsComposedBasis<real_t> >; ok
    //CLASS_TEMPLATE_INST gsXml< gsComposedGeometry<real_t> >;
    //CLASS_TEMPLATE_INST gsXml< gsComposedFunction<real_t> >; ok
    //CLASS_TEMPLATE_INST gsXml< gsFunctionSet<real_t> >; ok
    // CLASS_TEMPLATE_INST gsXml< gsFunction<real_t> >; ok

    //CLASS_TEMPLATE_INST gsXml< gsBezier<real_t> >;
    //CLASS_TEMPLATE_INST gsXml< gsMesh<real_t> >; ok
