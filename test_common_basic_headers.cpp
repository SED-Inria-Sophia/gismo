/** @file test_common_# Test basic Common module headers (without LinearAlgebra.h which needs Matrix module)
...
#include <gismo/Common/Debug.h>
#include <gismo/Common/Memory.h>
    @brief Test for basic gismo/Common module headers (excluding LinearAlgebra.h).

    This test verifies that the basic Common module headers can be included
    correctly without requiring full Matrix module dependencies.

    Usage:
    From build directory:
    g++ -I../src -I./src -std=c++17 ../test_common_basic_headers.cpp -o test_common_basic_headers
    ...
    Author(s): Generated test for Common module basic header verification
**/

#include <iostream>

// Test basic Common module headers (without LinearAlgebra.h which needs Matrix module)
...
int main() {
    std::cout << "=== G+Smo Common Module Basic Header Inclusion Test ===" << std::endl;
    std::cout << std::endl;
    ...
    std::cout << "Basic Common module headers compile correctly." << std::endl;
    std::cout << std::endl;
